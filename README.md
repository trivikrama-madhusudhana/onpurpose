...
The release source passes 62 automated tests. Earlier versions also have recorded live YouTube checks; the current release's latest interface changes have not yet had a fresh full live check. See the [verification record](evaluation/RESULTS.md#public-release-014).
