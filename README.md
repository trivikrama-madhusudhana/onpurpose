...
Use Chrome on a computer. You do not need to code.
...
2. Open the downloaded ZIP file. **Mac:** double-click it. **Windows:** right-click it and choose **Extract All**.
3. Find the folder with a file named `manifest.json` inside. You may need to open one more folder to see it.
4. Move that folder to **Documents**. Keep it there. Chrome needs it to run OnPurpose.

### 2. Add the folder to Chrome
...
4. Select the folder you moved to Documents. Choose the folder, not the ZIP file.

You should now see **OnPurpose** in the list.

### 3. Start using it

1. Click the puzzle-piece icon near Chrome's address bar. Click **OnPurpose**.
2. Settings will open. Paste your OpenRouter API key into **New API key**. Click **Save key**.
3. Open [YouTube](https://www.youtube.com/). Refresh it if it was already open.
4. Find **Your YouTube goal** below the search box. Type what you want to learn. Click **Set goal**.

Need a key? Follow [these steps](docs/INSTALL.md#3-connect-openrouter). OpenRouter charges for use; OnPurpose itself is free.

[Help with installation or updates](docs/INSTALL.md)
